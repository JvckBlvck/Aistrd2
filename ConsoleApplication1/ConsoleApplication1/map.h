...
template<class T>
inline void tree<T>::insert_case_cur_is_root(node*cur)
{
	if (cur->prev == NULL)
		cur->color = 'b';
	else
...
template<class T>
inline void tree<T>::insert_case_prev_is_black(node*cur)
{
	if (cur->prev->color == 'r')
...
template<class T>
inline void tree<T>::insert_case_prev_and_uncle_are_red(node*cur)
{
...
template<class T>
inline void tree<T>::insert_case_prev_is_red_and_uncle_is_black_and_if_prev_is_left_then_cur_is_right_else_conversely(node*cur)
{
	node*parent =cur->prev;
	node*granny = NULL;
	if (parent != NULL)
...
template<class T>
inline void tree<T>::insert_case_prev_is_red_and_uncle_is_black_and_if_prev_is_left_then_cur_is_left_else_conversely(node*cur)
{
	node*parent = cur->prev;
	node*granny = NULL;
	if (parent != NULL)
...
template<class T>
inline void tree<T>::remove_case_cur_is_root(node * cur)
{
	if (cur->prev != NULL)
...
template<class T>
inline void tree<T>::remove_case_brother_is_red(node * cur)
{
	node*parent = cur->prev;
	node*brother = NULL;
	if (parent != NULL)
...
template<class T>
inline void tree<T>::remove_case_prev_and_brother_and_brothers_children_are_black(node * cur)
{
	node*parent = cur->prev;
	node*brother = NULL;
	if (parent != NULL)
...
template<class T>
inline void tree<T>::remove_case_prev_is_red_and_brother_and_brothres_children_are_black(node * cur)
{
	node*parent = cur->prev;
	node*brother = NULL;
	if (parent != NULL)
...
template<class T>
inline void tree<T>::remove_case_brother_is_black_and_cur_is_left_and_brothers_right_is_black_and_brothers_left_is_black_or_cur_is_right_and_brothers_left_is_black_and_brothers_right_is_red(node * cur)
{
	node*parent = cur->prev;
	node*brother = NULL;
	if (parent != NULL)
...
template<class T>
inline void tree<T>::remove_case_cur_is_left_and_brother_is_black_and_brothers_right_is_red_or_cur_is_right_and_brother_is_black_and_brothers_left_is_red(node * cur)
{
	node*parent = cur->prev;
	node*brother = NULL;
	if (parent != NULL)
